'''
Store util functions for training and evaluation
'''
...
def cross_entropy(preds, trgts, num_class=10):
    '''
    ...
    And Uma:https://github.com/AlexandraUma/dali-learning-with-disagreement/blob/main/iccifar10/soft_loss.py
    '''
...
def get_model_preds(model, dataloader, num_classes=10, device="cuda", clear_cache_step=1000, select_indices=None, max_eval=None, pred_latents=False):
    ...
    for idx, (inputs, targets) in enumerate(dataloader):
        ...
        loss_val = cross_entropy(preds.to(device), targets.to(device)).item()
...
# '''
# The util functions below are from: https://github.com/facebookresearch/mixup-cifar10
# '''
#
#
