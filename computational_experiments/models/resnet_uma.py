'''
The same ResNet employed in Uma et al
ResNet-34
Code from Uma et al: https://github.com/AlexandraUma/dali-learning-with-disagreement/blob/main/iccifar10/soft_loss.py
'''
    ...
    def _make_layer(self, layer_count, channels, channels_in, stride):
        return nn.Sequential(
            ResBlock(channels, channels_in, stride,
                     res_option=self.res_option, use_dropout=self.use_dropout),
